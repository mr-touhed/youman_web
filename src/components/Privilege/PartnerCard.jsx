...
const PartnerCard = ({data}) => {
  const {name,image,offers,catagory,location} = data;
    ...
    {offers.discount && <span className="border border-green-300 bg-[#ffffffb0] backdrop-blur-sm h-6  px-2 text-green-700 text-xs flex justify-center items-center rounded-xl">{offers.discount}% Discount </span>}
