    ...
    return (
        ...
        <div className="grid md:grid-cols-2  grid-cols-1 gap-4 items-center  pt-8">
            ...
            <form onSubmit={handel_order} className="flex flex-col gap-4  ">
                    ...
                    <button type="submit" disabled={loading} className="bg-green-700 disabled:bg-green-400 p-2 md:rounded-md text-white uppercase md:relative fixed bottom-2  font-bold w-[90%] z-50">{loading ? "Loading..":"GET IT !"}</button>
                </form>
