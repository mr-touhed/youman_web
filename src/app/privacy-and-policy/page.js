...
const PrivacyPolicyPage = () => {
    return (
        <div className='max-w-7xl mx-auto px-4 text-base font-thin space-y-8 mb-16 '>
              <HeadingAnimation>
                            <h2 className='text-4xl font-semibold text-green-700 text-center'>Youman Privacy Policy</h2>
            </HeadingAnimation>
            ...
            <section>
            <h2 className='text-base font-semibold  '> 4. Sharing Your Information:</h2>
            ...
            <section>
            <h2 className='text-base font-semibold  '> 5. Data Security:
            </h2>
            ...
            <section>
            <h2 className='text-base font-semibold  '>6. Data Retention:
            </h2>
            ...
            <section>
            <h2 className='text-base font-semibold  '> 7. Your Rights:
            </h2>
            ...
            <section>
            <h2 className='text-base font-semibold  '> 8. Cookies and Tracking Technologies:</h2>
            ...
            <section>
            <h2 className='text-base font-semibold  '> 9. Changes to This Privacy Policy:</h2>
            ...
            <section>
            <h2 className='text-base font-semibold  '> 10. Contact Us:
            </h2>
